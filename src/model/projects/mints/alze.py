...
class Alze:
    ...
    async def mint_yappers(self):
        try:
            logger.info(f"{self.account_index} | Minting YAPPERS NFT on Alze...")

            # YAPPERS contract address
            contract_address = "0xF6e220FA8d944B512e9ef2b1d732C3a12F156B3c"
            ...
            if tx_hash:
                logger.success(
                    f"{self.account_index} | Successfully minted YAPPERS NFT"
                )
