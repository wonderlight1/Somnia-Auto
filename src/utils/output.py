...
def show_dev_info():
    ...
    table.add_row("✨ Somnia Bot 1.0 ✨")
    table.add_row("─" * 43)
    table.add_row("")
    table.add_row("⚡ GitHub: [link]https://github.com/neLNABR/Somnia[/link]")
    table.add_row("👤 Support: [link]https://t.me/jackthedevv[/link]")
    table.add_row(
        "📚 Tutorial: [link]https://nelnabr.gitbook.io[/link]"
    )
    table.add_row("")
